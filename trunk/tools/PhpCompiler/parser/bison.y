...
P_GLOBAL_CALL:		IDENTIFIER P_RARG_BRACKETS
		;
...
P_INTERFACE_DECL:	INTERFACE IDENTIFIER OPEN_BRACE P_INTERFACE_LINES CLOSE_BRACE
		;
...
P_ABSTRACT_CLASS_DECL:	ABSTRACT CLASS IDENTIFIER P_EXTENSION OPEN_BRACE P_CLASS_LINES CLOSE_BRACE
		;
...
P_NEW:		NEW P_GLOBAL_CALL
		;


/* L-VALUES */

P_LVALUE:	P_INDEXED_VARIABLE
		|	P_LINDEXED_VARIABLE
		|	P_SCALAR_VARIABLE
		|	P_LIST
		;

/* This is currently only 1-level deep. */
P_INDEXED_VARIABLE:	P_SCALAR_VARIABLE OPEN_SQUARE P_RVALUE CLOSE_SQUARE
		;
